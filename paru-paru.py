...
with col1:
   No = st.number_input('Nomor Pasien')
...
if st.button('Hasil Prediksi'):
    predik = model.predict([[No, Usia, Aktivitas_Begadang, Jenis_Kelamin, Aktivitas_Olahraga, Merokok, Asuransi, Bekerja, Penyakit_Bawaan, Rumah_Tangga]])
